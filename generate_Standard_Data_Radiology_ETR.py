...
from selenium.webdriver.common.keys import Keys #Imports key class to simulate keyboard presses like enter, tab etc for input automation
...
class TestETR:
    ...
    def test_generate_standard_rad_etr(self, driver, username, password, tpnhs):
        ...
        clin_question.send_keys(TEST_CLINICAL_QUESTION_STANDARD)
